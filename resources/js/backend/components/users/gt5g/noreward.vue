    ...
    <main class="mb-5 pb-5">
        <div>
            ...
            <div class="bg-gd p-3  text-white">
                ...
                <p class="font-monospace lh-1 lh-sm mb-0 mb-2 pb-0 px-3 py-3">When your Tier 1 team members invest, you will directly earn 10% of their return on investment. If

                    your Tier 1 member earns $100 per day, you will get 8% of 100 per day. If your tier 2 members earn

                    100 per day, you will get 3% of 100 per day. If your tier 3 member earns 100 per day, you get 1%

                    of 100 per day. etc. If your team has 10 members or 100 members, this will be a longer-term</p>
            </div>
            ...
            <div class="bg-gd p-3  text-white">
                ...
                <div class="bg-gdd p-3 rounded-1">
                    <table style="width: 100%;">
                        <thead>
                            <tr>
                                <th>First Level Member topup</th>
