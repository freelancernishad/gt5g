...
let Authuser = require('./components/users/gt5g/index.vue').default;
let Earning = require('./components/users/gt5g/earning.vue').default;
let team = require('./components/users/gt5g/team.vue').default;
let share = require('./components/users/gt5g/share.vue').default;
let account = require('./components/users/gt5g/account.vue').default;
let treasure = require('./components/users/gt5g/treasure.vue').default;
let banlance = require('./components/users/gt5g/banlance.vue').default;
...
let RechargeRecord = require('./components/users/gt5g/RechargeRecord.vue').default;
let withdraw = require('./components/users/gt5g/withdraw.vue').default;
